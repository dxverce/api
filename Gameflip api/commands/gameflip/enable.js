...
module.exports = {
    name: 'enable',
    description: 'Enable any of your Saved Listing.',
    category: 'gameflip',
    cooldown: 2,
    aliases: ['resume'],
    ...
    run: async (client, message, args) => {
        ...
        try {
            ...
            if (Object.keys(enabled).length == 0) return await errorEmbed2(msg, 'No Saved Listing Found:(')

            let ListingNum = args[0]
            if (!ListingNum) return await errorEmbed2(msg, 'Provide Listing Index (Number of Listing) that you want to Enable')
            if (isNaN(ListingNum)) return await errorEmbed2(msg, 'Provide VALID Listing Index (Number of Listing) that you want to Enable')
            ...
            enabled[listingId].isDisabled = false
            ...
            .setDescription('Successfully Enabled this Listing from your Saved Listings!')
            .setColor('RANDOM')
            .setTimestamp()
